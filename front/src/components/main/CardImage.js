import ice_burg from "assets/images/background_iceberg.webp";
import forest from "assets/images/background_forest.webp";
import underwater from "assets/images/background_underwater.webp";
import desert from "assets/images/background_desert.webp";
...
const CardImage = (props) => {
  return (
    <div>
      <img
        className={`absolute w-[150%] h-[120%] max-w-xl right-[-23%] rounded-2xl bg-cover shadow-2xl shadow-white`}
        src={coverImages[props.id]}
      />
      {props.main === props.id && (
        <img
          src={games[props.id].animal}
          className="absolute max-w-xl right-[-15%] top-[-50%] w-[130%] h-[110%]"
        />
      )}
