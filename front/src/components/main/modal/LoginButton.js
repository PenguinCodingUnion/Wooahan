...
const LoginButton = () => {
  useEffect(() => {
    gapi.load("auth2", () => {
      gapi.auth2.init({
        client_id:
          "658207955186-n84qpvfhtdi82n6mfvbmh6v99aevulv7.apps.googleusercontent.com",
      });
    });
  }, []);
  ...
  const login = async () => {
    ...
    try {
      ...
      // Here you can send id_token to your backend and validate it,
      // or you can handle it in your app.
