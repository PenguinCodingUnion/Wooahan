...
export const Bubble = (props) => {
  ...
  const pointcss = [
    " rounded-full left-[30%] top-[20%] absolute h-[15rem] w-[15rem] shadow-[0_-1000px_1000px_1000px_rgba(169,169,169,0.4)]",
    "rounded-full left-[68%] top-[13%] absolute h-[12em] w-[12em] shadow-[0_-1000px_1000px_1000px_rgba(169,169,169,0.4)]",
  ...
  return (
    <div className="relative h-full w-full overflow-hidden">
      ...
      <div
        ...
        className=" bg-mainYellow-300 shadow-xl rounded-lg top-3 right-0 w-28 h-12 mr-6 font-MaplestoryBold text-2xl absolute leading-[3rem]"
      >
        <p>{bntmention[idx]}</p>
      </div>
