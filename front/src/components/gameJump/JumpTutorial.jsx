...
export const Jump = (props) => {
  ...
  return (
    <div className="absolute top-0 z-[99999999] w-screen h-screen bg-mainBlue-200">
      <div className="absolute z-[99999999] w-5/6 overflow-hidden rounded-xl h-5/6 top-[8.333333%] left-[8.333333%] shadow-2xl">
        <div className={pointcss[idx]}></div>
        <div className={mentioncss[idx]}>
          <div className="relative flex justify-normal">
            <p className="whitespace-nowrap text-center bg-white rounded-md border px-3 font-netmarbleB text-[1.7em] leading-[1.7em]">
              {mention[idx]}
            </p>
          </div>
        </div>
        ...
        <div
          ...
          className=" bg-mainYellow-300 shadow-xl rounded-lg bottom-5 right-0 w-24 h-12 mr-6 font-MaplestoryBold text-2xl absolute leading-[3rem] text-center"
        >
          <p>{bntmention[idx]}</p>
        </div>
